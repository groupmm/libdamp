...
class WeightedPulseTableSynthesizer(torch.nn.Module):
    ...
    def __init__(self, mode, table, table_mask, fs, N):
        ...
        self.envelope = libdamp.processors.GainEnvelope(interp_mode="end_linear")
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if pulse_init == "tp":
            ...
            initial_table[:, :62] = torch.tensor([
                 0.00320435,  0.02990723,  0.05715942,
                ...
                -0.65069580, -0.65618896, -0.63525391,
